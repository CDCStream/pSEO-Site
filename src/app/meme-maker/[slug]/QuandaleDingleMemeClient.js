...
const TEMPLATE_SRC = '/memes/quandale-dingle-meme-template.jpg';
...
const PRESET_COLORS = ['#ffffff', '#000000', '#39ff14', '#ff0000', '#00ff00', '#0000ff', '#ffff00', '#ff00ff', '#00ffff', '#ff6600'];

let nextId = 1;

export default function QuandaleDingleMemeClient() {
  ...
  const handleDownload = () => {
    ...
    link.download = `quandale-dingle-meme.png`;
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white/5 rounded-lg border border-dashed border-white/20 p-3 text-center">
            <p className="text-xs text-gray-500">
              Click on the image to place text. Drag to reposition. Press Enter inside a text box for a new line.
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-2 p-2">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="flex-1 px-2 py-1.5 rounded bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-lime-500/50 placeholder-gray-600 resize-none leading-snug"
                  />
                  <button
                  ...
                  <div className="px-2 pb-2 pt-1 border-t border-white/5 space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        ...
                        className="flex-1 px-2 py-1 rounded bg-white/5 border border-white/10 text-white text-xs focus:outline-none focus:border-lime-500/50 appearance-none cursor-pointer"
                      >
                        {FONTS.map((f) => (
                    ...
                    <div className="flex items-center gap-2">
                      <label className="text-[10px] text-gray-500 uppercase w-10 shrink-0">Case</label>
                      <button
                        onClick={(e) => { e.stopPropagation(); updateBoxStyle(box.id, 'uppercase', !(box.uppercase !== false)); }}
                      ...
                      >
                        {box.uppercase !== false ? 'UPPERCASE' : 'as typed'}
                      </button>
                    </div>
                        ...
                        {PRESET_COLORS.map((c) => (
                          <button
                            ...
                            className={`w-5 h-5 rounded-full border-2 transition-transform ${
                              (box.color || '#ffffff') === c ? 'border-lime-400 scale-125' : 'border-white/20'
                            }`}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-1 flex-wrap">
                        {['#000000', '#ffffff', '#39ff14', '#ff0000', '#0000ff', 'none'].map((c) => (
                          <button
                            key={c}
                            onClick={(e) => { e.stopPropagation(); updateBoxStyle(box.id, 'stroke', c); }}
                            className={`w-5 h-5 rounded-full border-2 transition-transform ${
                              (box.stroke || '#000000') === c ? 'border-lime-400 scale-125' : 'border-white/20'
                            }`}
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gradient-to-r from-lime-500 to-emerald-500 text-white font-semibold hover:opacity-90 transition-opacity mt-4 inline-flex items-center justify-center gap-2"
          >
        ...
        <div>
          ...
          >
            <img
              ref={imgRef}
              src={TEMPLATE_SRC}
              alt="Quandale Dingle meme template"
