...
const TEMPLATES = [
  { id: 0, src: '/trump-meme-templates/trump-meme-template1.jpg', label: 'Template 1' },
  { id: 1, src: '/trump-meme-templates/trump-meme-template2.jpg', label: 'Template 2' },
  { id: 2, src: '/trump-meme-templates/trump-meme-template3.jpg', label: 'Template 3' },
  { id: 3, src: '/trump-meme-templates/trump-meme-template4.jpg', label: 'Template 4' },
  { id: 4, src: '/trump-meme-templates/trump-meme-template5.jpg', label: 'Template 5' },
  { id: 5, src: '/trump-meme-templates/trump-meme-template6.jpg', label: 'Template 6' },
  { id: 6, src: '/trump-meme-templates/trump-meme-template7.jpg', label: 'Template 7' },
  { id: 7, src: '/trump-meme-templates/trump-meme-template8.jpg', label: 'Template 8' },
  { id: 8, src: '/trump-meme-templates/trump-meme-template9.jpg', label: 'Template 9' },
  { id: 9, src: '/trump-meme-templates/trump-meme-template10.jpg', label: 'Template 10' },
  { id: 10, src: '/trump-meme-templates/trump-meme-template11.jpg', label: 'Template 11' },
];
...
export default function TrumpMemeClient() {
  ...
  const handleDownload = () => {
    ...
    link.download = `trump-meme-${selected + 1}.png`;
                        ...
                        {PRESET_COLORS.map((c) => (
                          <button
                            ...
                            className={`w-5 h-5 rounded-full border-2 transition-transform ${
                              (box.color || '#ffffff') === c ? 'border-red-400 scale-125' : 'border-white/20'
                            }`}
                      ...
                      <div className="flex items-center gap-1 flex-wrap">
                        {['#000000', '#ffffff', '#ff0000', '#0000ff', '#ffff00', 'none'].map((c) => (
                          <button
                            ...
                            className={`w-5 h-5 rounded-full border-2 transition-transform ${
                              (box.stroke || '#000000') === c ? 'border-red-400 scale-125' : 'border-white/20'
                            }`}
        ...
        <div>
          ...
          >
            <img
              ...
              alt={`Trump Meme Template ${selected + 1}`}
