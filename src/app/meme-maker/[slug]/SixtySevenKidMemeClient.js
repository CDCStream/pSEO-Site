...
const TEMPLATE_SRC = '/memes/67-kid-meme-template.png';
...
export default function SixtySevenKidMemeClient() {
        ...
        <div className="space-y-4">
          <div className="flex gap-2 mb-2">
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-medium transition-colors ${mode === 'text' ? 'bg-orange-500 text-white' : 'bg-white/5 text-gray-400 hover:bg-white/10'}`}
            >
              Add Text
            </button>
            <label className={`flex-1 py-2 rounded-lg text-sm font-medium text-center cursor-pointer transition-colors ${mode === 'image' ? 'bg-orange-500 text-white' : 'bg-white/5 text-gray-400 hover:bg-white/10'}`}>
              Upload Image
          ...
          {imageBoxes.length > 0 && (
            <div className="space-y-3">
              ...
              {imageBoxes.map((ib) => (
                <div
                  key={ib.id}
                  className={`rounded-lg border p-2 transition-colors ${activeImg === ib.id ? 'border-orange-500/50 bg-orange-500/10' : 'border-white/10 bg-white/5'}`}
                      ...
                      <div className="flex items-center gap-1 flex-wrap">
                        {PRESET_COLORS.map((c) => (
                          <button
                            ...
                            className={`w-5 h-5 rounded-full border-2 transition-transform ${(box.color || '#ffffff') === c ? 'border-orange-400 scale-125' : 'border-white/20'}`}
                      ...
                      <div className="flex items-center gap-1 flex-wrap">
                        {['#000000', '#ffffff', '#ff0000', '#0000ff', '#ffff00', 'none'].map((c) => (
                          <button
                            ...
                            className={`w-5 h-5 rounded-full border-2 transition-transform ${(box.stroke || '#000000') === c ? 'border-orange-400 scale-125' : 'border-white/20'}`}
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gradient-to-r from-orange-600 to-orange-500 text-white font-semibold hover:opacity-90 transition-opacity mt-4 inline-flex items-center justify-center gap-2"
          >
