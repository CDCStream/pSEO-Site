...
const TEMPLATES = [
  { id: 0, src: '/charlie-kirk-meme-templates/charlie-kirk-meme-template1.jpg', label: 'Template 1' },
  { id: 1, src: '/charlie-kirk-meme-templates/charlie-kirk-meme-template2.png', label: 'Template 2' },
  { id: 2, src: '/charlie-kirk-meme-templates/charlie-kirk-meme-template3.jpg', label: 'Template 3' },
  { id: 3, src: '/charlie-kirk-meme-templates/charlie-kirk-meme-template4.jpg', label: 'Template 4' },
  { id: 4, src: '/charlie-kirk-meme-templates/charlie-kirk-meme-template5.jpg', label: 'Template 5' },
  { id: 5, src: '/charlie-kirk-meme-templates/charlie-kirk-meme-template6.jpg', label: 'Template 6' },
];
...
export default function CharlieKirkMemeClient() {
  ...
  const handleDownload = () => {
    ...
    link.download = `charlie-kirk-meme-${selected + 1}.png`;
        ...
        <div>
          ...
          >
            <img
              ...
              alt={`Charlie Kirk Meme Template ${selected + 1}`}
