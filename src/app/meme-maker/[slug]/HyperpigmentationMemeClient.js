...
const TEXT_ZONES = [
  { id: 'left', label: 'Left Side Text', x: 0.02, y: 0.82, w: 0.47, h: 0.16, fontSize: 30, align: 'center', valign: 'middle', color: '#fff', stroke: '#000' },
  { id: 'right', label: 'Right Side Text', x: 0.51, y: 0.82, w: 0.47, h: 0.16, fontSize: 30, align: 'center', valign: 'middle', color: '#fff', stroke: '#000' },
];
...
export default function HyperpigmentationMemeClient() {
  ...
  const handleDownload = () => {
    ...
    link.download = 'hyperpigmentation-meme.png';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="rounded-xl overflow-hidden border border-white/10 bg-black/20">
            <img
              ref={imgRef}
              src="/memes/hyperpigmentation-meme.png"
              alt="Hyperpigmentation Meme Template"
