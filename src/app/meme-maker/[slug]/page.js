...
import KneeSurgeryMemeGalleryClient from './KneeSurgeryMemeGalleryClient';
import SixtySevenKidMemeClient from './SixtySevenKidMemeClient';
import AlphaWolfMemeClient from './AlphaWolfMemeClient';
import ChickenStarsMemeClient from './ChickenStarsMemeClient';
import WillemDafoeMemeClient from './WillemDafoeMemeClient';
import MegamindMemeClient from './MegamindMemeClient';
...
const chickenStarsMemeSteps = [
  {
    icon: Image,
    title: 'View Template',
    description: 'The Chicken Stars meme template is loaded and ready for your captions and images.',
  },
  {
    icon: Type,
    title: 'Click to Place Text',
    description: 'Click anywhere on the chicken template to drop a text box. Drag to reposition.',
  },
  {
    icon: UploadIcon,
    title: 'Upload Images',
    description: 'Upload your own photos and place them on the meme. Resize and drag to position.',
  },
  {
    icon: Download,
    title: 'Download PNG',
    description: 'Download your custom Chicken Stars meme as a high-quality PNG image.',
  },
];

const megamindMemeSteps = [
  {
    icon: Image,
    title: 'View Template',
    description: 'The iconic Megamind sad-face peeking template is loaded and ready for your "no bitches?" caption and image overlays.',
  },
  {
    icon: Type,
    title: 'Click to Place Text',
    description: 'Click anywhere on the Megamind template to drop a text box. Drag to reposition, press Enter for line breaks, customize font, size, color, and stroke.',
  },
  {
    icon: UploadIcon,
    title: 'Upload Image (Optional)',
    description: 'Upload your own photo to layer on top — perfect for face swaps, sticker reactions, or putting yourself into the iconic peeking pose. Resize with the slider and drag anywhere.',
  },
  {
    icon: Download,
    title: 'Download PNG',
    description: 'Download your custom Megamind meme as a high-quality PNG. No watermark, no signup, instant.',
  },
];

const willemDafoeMemeSteps = [
  {
    icon: Image,
    title: 'View Template',
    description: 'The Willem Dafoe meme template is loaded and ready for your captions and image overlays.',
  },
  {
    icon: Type,
    title: 'Click to Place Text',
    description: 'Click anywhere on the Willem Dafoe template to drop a text box. Drag to reposition, customize font, size, color, and stroke.',
  },
  {
    icon: UploadIcon,
    title: 'Upload Image (Optional)',
    description: 'Upload your own photo to layer on top \u2014 perfect for face swaps, sticker reactions, or logo overlays. Resize with the slider and drag anywhere.',
  },
  {
    icon: Download,
    title: 'Download PNG',
    description: 'Download your custom Willem Dafoe meme as a high-quality PNG. No watermark, no signup, instant.',
  },
];

const alphaWolfMemeSteps = [
  {
    icon: Image,
    title: 'View Template',
    description: 'The Alpha Wolf meme template is ready for your custom text and images.',
  },
  {
    icon: Type,
    title: 'Click to Place Text',
    description: 'Click anywhere on the image to add text boxes. Drag to reposition.',
  },
  {
    icon: UploadIcon,
    title: 'Upload Images',
  ...
  },
  {
    icon: Download,
    title: 'Download PNG',
    description: 'Download your custom Alpha Wolf meme as a high-quality PNG image.',
  },
];

const sixtySevenKidMemeSteps = [
  {
    icon: Image,
    title: 'View Template',
    description: 'The 67 Kid meme template is ready for your custom text and images.',
  },
  {
    icon: Type,
    title: 'Click to Place Text',
  ...
  },
  {
    icon: Download,
    title: 'Download PNG',
    description: 'Download your custom 67 Kid meme as a high-quality PNG image.',
  },
];
...
const kneeSurgeryMemeSteps = [
  {
    icon: Search,
    title: 'Browse Collection',
    description: 'Scroll through 8 funny knee surgery recovery meme GIFs that play automatically as you browse.',
  },
  {
    icon: Image,
    title: 'Preview',
  ...
  },
  {
    icon: Download,
    title: 'Download',
    description: 'Click the download button to save the knee surgery meme GIF to your device. No watermark, no signup.',
  },
  {
    icon: Share2,
    title: 'Share Everywhere',
    description: 'Send it to a friend recovering from ACL or knee replacement surgery, post in support groups, or use in WhatsApp/Discord.',
  },
];
...
const whatMemeSteps = [
  {
    icon: Search,
    title: 'Browse Collection',
    description: 'Scroll through 8 hilarious "what?" reaction GIFs.',
  },
  {
    icon: Image,
    title: 'Preview',
  ...
  },
  {
    icon: Download,
    title: 'Download',
    description: 'Download any "what" meme as an animated GIF file.',
  },
  {
    icon: Share2,
    title: 'Share Everywhere',
...
const sheeshMemeSteps = [
  {
    icon: Search,
    title: 'Browse Collection',
    description: 'Scroll through 14 hilarious "sheesh!" reaction GIFs.',
  },
  {
    icon: Image,
    title: 'Preview',
  ...
  },
  {
    icon: Download,
    title: 'Download',
    description: 'Download any sheesh meme as an animated GIF file.',
  },
  {
    icon: Share2,
    title: 'Share Everywhere',
...
const airballMemeSteps = [
  {
    icon: Search,
    title: 'Browse Collection',
    description: 'Scroll through 15 hilarious airball reaction GIFs.',
  },
  {
    icon: Image,
    title: 'Preview',
  ...
  },
  {
    icon: Download,
    title: 'Download',
    description: 'Download any airball meme as an animated GIF file.',
  },
  {
    icon: Share2,
    title: 'Share Everywhere',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8">
          <div className="flex-1 min-w-0">
            ...
            ) : slug === 'knee-surgery-meme' ? (
              <KneeSurgeryMemeGalleryClient />
            ) : slug === '67-kid-meme' ? (
              <SixtySevenKidMemeClient />
            ) : slug === 'alpha-wolf-meme' ? (
              <AlphaWolfMemeClient />
            ) : slug === 'chicken-stars-meme' ? (
              <ChickenStarsMemeClient />
            ) : slug === 'willem-dafoe-meme' ? (
              <WillemDafoeMemeClient />
            ) : slug === 'megamind-meme' ? (
              <MegamindMemeClient />
            ) : slug === 'what-meme' ? (
