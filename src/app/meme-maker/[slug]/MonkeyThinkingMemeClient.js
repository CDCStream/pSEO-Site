...
const TEMPLATE_SRC = '/memes/monkey-thinking-meme-templete.webp';
...
export default function MonkeyThinkingMemeClient() {
  ...
  const handleDownload = () => {
    ...
    link.download = 'monkey-thinking-meme.png';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
                        ...
                        {PRESET_COLORS.map((c) => (
                          <button
                            ...
                            className={`w-5 h-5 rounded-full border-2 transition-transform ${
                              (box.color || '#ffffff') === c ? 'border-purple-400 scale-125' : 'border-white/20'
                            }`}
                      ...
                      <div className="flex items-center gap-1 flex-wrap">
                        {['#000000', '#ffffff', '#ff0000', '#0000ff', '#ffff00', 'none'].map((c) => (
                          <button
                            ...
                            className={`w-5 h-5 rounded-full border-2 transition-transform ${
                              (box.stroke || '#000000') === c ? 'border-purple-400 scale-125' : 'border-white/20'
                            }`}
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gradient-to-r from-purple-500 to-violet-500 text-white font-semibold hover:opacity-90 transition-opacity mt-4 inline-flex items-center justify-center gap-2"
          >
        ...
        <div>
          ...
          >
            <img
              ref={imgRef}
              src={TEMPLATE_SRC}
              alt="Monkey Thinking Meme Template"
