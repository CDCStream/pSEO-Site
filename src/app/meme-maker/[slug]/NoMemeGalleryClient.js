...
const ALL_IMAGES = Array.from({ length: 13 }, (_, i) => ({
  id: i,
  src: `/no-meme/no-meme${i + 1}.gif`,
  ext: 'gif',
  alt: `No Meme ${i + 1} - Funny "No" Reaction GIF`,
}));

export default function NoMemeGalleryClient() {
        ...
        {ALL_IMAGES.map((img, i) => (
          ...
          >
            ...
            <button
              ...
              className="absolute bottom-2 right-2 p-2 bg-red-500/90 hover:bg-red-400 text-white rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 backdrop-blur-sm"
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4" onClick={(e) => e.stopPropagation()}>
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-red-500 hover:bg-red-400 text-white rounded-xl font-semibold transition-colors"
            >
