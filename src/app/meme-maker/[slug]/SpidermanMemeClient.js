              ...
              >
                <div className="flex items-center gap-2 p-2">
                  ...
                  <input
                    ...
                    className="flex-1 px-2 py-1.5 rounded bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-red-500/50 placeholder-gray-600"
                  />
                  <button
