...
const ALL_IMAGES = Array.from({ length: 25 }, (_, i) => ({
  id: i,
  src: `/labubu-wallpapers/labubu-wallpaper${i + 1}.png`,
  alt: `Labubu Wallpaper ${i + 1} - Cute Labubu Phone Background HD`,
}));

export default function LabubuGalleryClient() {
  ...
  const handleDownload = async (src, idx) => {
    try {
      ...
      a.href = url;
      a.download = `labubu-wallpaper-${idx + 1}.png`;
      a.click();
