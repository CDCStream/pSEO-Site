...
const ALL_IMAGES = Array.from({ length: 32 }, (_, i) => ({
  id: i,
  src: `/naruto-wallpapers/naruto-wallpaper${i + 1}.png`,
  alt: `Naruto Wallpaper ${i + 1} - Naruto Uzumaki, Sasuke, Kakashi, and Konoha HD Phone Background`,
}));

export default function NarutoGalleryClient() {
  ...
  const handleDownload = async (src, idx) => {
    try {
      ...
      a.href = url;
      a.download = `naruto-wallpaper-${idx + 1}.png`;
      a.click();
