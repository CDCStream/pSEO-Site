...
const ALL_IMAGES = Array.from({ length: 24 }, (_, i) => ({
  id: i,
  src: `/cute-walpaper/cute-walpaper${i + 1}.png`,
  alt: `Cute Wallpaper ${i + 1} - Adorable Aesthetic Phone Background HD`,
}));

export default function CuteGalleryClient() {
  ...
  const handleDownload = async (src, idx) => {
    try {
      ...
      a.href = url;
      a.download = `cute-wallpaper-${idx + 1}.png`;
      a.click();
