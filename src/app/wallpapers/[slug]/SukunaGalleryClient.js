...
const ALL_IMAGES = Array.from({ length: 32 }, (_, i) => ({
  id: i,
  src: `/sukuna-wallpapers/sukuna-wallpaper${i + 1}.png`,
  alt: `Sukuna Wallpaper ${i + 1} - Ryomen Sukuna King of Curses Jujutsu Kaisen HD Phone Background`,
}));

export default function SukunaGalleryClient() {
  ...
  const handleDownload = async (src, idx) => {
    try {
      ...
      a.href = url;
      a.download = `sukuna-wallpaper-${idx + 1}.png`;
      a.click();
