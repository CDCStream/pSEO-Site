...
const ALL_IMAGES = Array.from({ length: 24 }, (_, i) => ({
  id: i,
  src: `/black-walpeper/black-walpeper${i + 1}.png`,
  alt: `Black Wallpaper ${i + 1} - Dark Aesthetic AMOLED Phone Background HD`,
}));

export default function BlackGalleryClient() {
  ...
  const handleDownload = async (src, idx) => {
    try {
      ...
      a.href = url;
      a.download = `black-wallpaper-${idx + 1}.png`;
      a.click();
        ...
        {ALL_IMAGES.map((img, i) => (
          ...
          >
            ...
            <button
              ...
              className="absolute bottom-2 right-2 p-2 bg-gray-700/90 hover:bg-gray-600 text-white rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 backdrop-blur-sm"
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4" onClick={(e) => e.stopPropagation()}>
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-xl font-semibold transition-colors"
            >
