...
const ALL_IMAGES = Array.from({ length: 24 }, (_, i) => ({
  id: i,
  src: `/king-von-wallpapers/king-von-wallpaper${i + 1}.png`,
  alt: `King Von Wallpaper ${i + 1} - King Von HD Phone Background`,
}));

export default function KingVonGalleryClient() {
  ...
  const handleDownload = async (src, idx) => {
    try {
      ...
      a.href = url;
      a.download = `king-von-wallpaper-${idx + 1}.png`;
      a.click();
