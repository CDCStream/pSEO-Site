...
export default async function sitemap() {
  ...
  const staticPages = [
    ...
    {
      url: `${baseUrl}/memes/what-meme/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/memes/sheesh-meme/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/memes/airball-meme/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/calculators/p-value-calculator/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/calculators/palworld-breeding-calculator/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/calculators/a1c-calculator/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/tools/adobe-qr-code-generator/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/converters/heic-to-jpg/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/converters/instagram-highlights-viewer/`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
