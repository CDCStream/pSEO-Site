...
- The poster MUST fill the ENTIRE output image edge-to-edge with ZERO empty space or padding around it.
- Do NOT place the poster as a smaller element inside a larger background. The poster IS the image.
- Do NOT add any extra background, margin, or border around the poster.
- The output must look exactly like the input template in terms of composition — just with updated text.`;
